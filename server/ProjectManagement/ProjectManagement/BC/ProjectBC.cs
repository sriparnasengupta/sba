...
namespace ProjectManagement.BC
{
    public class ProjectBC
    {
        ...
        public ProjectBC(DAC.ProjectManagementEntities context)
        {
            dbContext = context;
        }
        public List<Project> RetrieveProjects()
        {
            using (dbContext)
            {
                return dbContext.Projects.Select(x => new Project()
                {
                    ...
                    Priority = x.Priority,
                    User = dbContext.Users.Where(y => y.Project_ID == x.Project_ID).Select(z => new User()
                    {
                        UserId = z.User_ID
                    }).FirstOrDefault(),
